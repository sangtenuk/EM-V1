                  ...
                  >
                    ...
                    <div className="mt-2 space-y-1">
                      {tableAttendees.slice(0, 3).map((attendee) => (
                        <div key={attendee.id} className="text-xs bg-white bg-opacity-20 rounded px-2 py-1 truncate">
                          {attendee.name}
                        </div>
                      ))}
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {unassignedAttendees.map((attendee) => (
                <div key={attendee.id} className="p-3 border border-gray-200 rounded-lg">
